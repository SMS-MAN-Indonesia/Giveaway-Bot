...
class DrawProgress(Base):
    ...
    def __repr__(self):
        return "<DrawProgress(id='%s', user_id='%s', chanel_id='%s', chanel_name='%s', text='%s', file_type='%s', file_id='%s', winers_count='%s', post_time='%s', end_time='%s')>" % (
            self.id, self.user_id, self.chanel_id, self.chanel_name, self.text, self.file_type, self.file_id, self.winers_count, self.post_time, self.end_time)
...
class Draw(Base):
    ...
    def __repr__(self):
        return "<DrawProgress(id='%s', user_id='%s', message_id='%s' chanel_id='%s', chanel_name='%s', text='%s', file_type='%s', file_id='%s', winers_count='%s', post_time='%s', end_time='%s')>" % (
            self.id, self.user_id, self.message_id, self.chanel_id, self.chanel_name, self.text, self.file_type, self.file_id, self.winers_count, self.post_time, self.end_time)
